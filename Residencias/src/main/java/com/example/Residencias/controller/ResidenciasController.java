...
public class ResidenciasController {
    ...
    public ResponseEntity<?> asignarUsuarioAResidencia(@PathVariable Integer residenciaId,
    ...
    public ResponseEntity<?> removerUsuarioDeResidencia(@PathVariable Integer residenciaId,
            @PathVariable Integer userId) {
        try {
